...
type Config struct {
	...
	InstagramApplicationSecret string `help:"the Instagram app secret"`
	InstagramWebhookSecret     string `help:"the secret for Instagram webhook URL verification"`
...
func NewConfig() *Config {
	return &Config{
		...
		InstagramApplicationSecret: "missing_instagram_app_secret",
