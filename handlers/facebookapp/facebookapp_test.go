...
var SendTestCasesFBA = []ChannelSendTestCase{
	{
		Label:                "Text only chat message within 24 hour window",
		MsgText:              "Simple Message",
		MsgURN:               "facebook:12345",
		MsgOrigin:            courier.MsgOriginChat,
		MsgContactLastSeenOn: Ago(5 * time.Hour),
	...
	{
		Label:                   "Text only flow response within 24 hour window",
		MsgText:                 "Simple Message",
		MsgURN:                  "facebook:12345",
		MsgOrigin:               courier.MsgOriginFlow,
		MsgContactLastSeenOn:    Ago(1 * time.Minute),
	...
	{
		Label:                "Text only chat message outside of 24 hour window",
		MsgText:              "Simple Message",
		MsgURN:               "facebook:12345",
		MsgOrigin:            courier.MsgOriginChat,
		MsgContactLastSeenOn: Ago(30 * time.Hour),
		MockResponseBody:     `{"message_id": "mid.133"}`,
		MockResponseStatus:   200,
	...
	},
	{
		...
		MockResponseBody:    `{"message_id": "mid.133"}`,
		MockResponseStatus:  200,
		ExpectedRequestBody: `{"messaging_type":"MESSAGE_TAG","tag":"ACCOUNT_UPDATE","recipient":{"id":"12345"},"message":{"text":"Are you happy?","quick_replies":[{"title":"Yes","payload":"Yes","content_type":"text"},{"title":"No","payload":"No","content_type":"text"}]}}`,
		ExpectedMsgStatus:   "W",
		ExpectedExternalID:  "mid.133",
		SendPrep:            setSendURL,
	},
	...
	},
	{
		...
		MockResponseBody:    `{"message_id": "mid.133"}`,
		MockResponseStatus:  200,
		ExpectedRequestBody: `{"messaging_type":"MESSAGE_TAG","tag":"ACCOUNT_UPDATE","recipient":{"id":"12345"},"message":{"attachment":{"type":"image","payload":{"url":"https://foo.bar/image.jpg","is_reusable":true}}}}`,
		ExpectedMsgStatus:   "W",
		ExpectedExternalID:  "mid.133",
		SendPrep:            setSendURL,
	},
	...
	},
	{
		...
		MockResponseBody:    `{"message_id": "mid.133"}`,
		MockResponseStatus:  200,
		ExpectedRequestBody: `{"messaging_type":"MESSAGE_TAG","tag":"ACCOUNT_UPDATE","recipient":{"id":"12345"},"message":{"attachment":{"type":"file","payload":{"url":"https://foo.bar/document.pdf","is_reusable":true}}}}`,
		ExpectedMsgStatus:   "W",
		ExpectedExternalID:  "mid.133",
		SendPrep:            setSendURL,
	},
