...
var testCasesWAC = []ChannelHandleTestCase{
	...
	},
	{
		...
		ExpectedRespStatus:    200,
		ExpectedBodyContains:  "Handled",
		ExpectedErrors:        []*courier.ChannelError{courier.ErrorServiceSpecific("whatsapp_cloud", "131051", "Unsupported message type")},
		NoInvalidChannelCheck: true,
		PrepRequest:           addValidSignature,
	},
	{
		...
		ExpectedRespStatus:    200,
		ExpectedBodyContains:  "Handled",
		ExpectedErrors:        []*courier.ChannelError{courier.ErrorServiceSpecific("whatsapp_cloud", "0", "We were unable to authenticate the app user")},
		NoInvalidChannelCheck: true,
		PrepRequest:           addValidSignature,
	},
	{
	...
	},
	{
		...
		ExpectedMsgStatus:    "F",
		ExpectedExternalID:   "external_id",
		ExpectedErrors:       []*courier.ChannelError{courier.ErrorServiceSpecific("whatsapp_cloud", "131014", "Request for url https://URL.jpg failed with error: 404 (Not Found)")},
		PrepRequest:          addValidSignature,
	},
	{
...
var SendTestCasesWAC = []ChannelSendTestCase{
	...
	},
	{
		...
		MockResponseStatus: 403,
		ExpectedErrors:     []*courier.ChannelError{courier.NewChannelError("unable to unmarshal response body", "")},
		ExpectedMsgStatus:  "E",
		SendPrep:           setSendURL,
	},
	{
		...
		MockResponseStatus: 403,
		ExpectedErrors:     []*courier.ChannelError{courier.ErrorServiceSpecific("whatsapp_cloud", "130429", "(#130429) Rate limit hit")},
		ExpectedMsgStatus:  "E",
		SendPrep:           setSendURL,
	},
}
