...
var testCasesFBA = []ChannelHandleTestCase{
	...
	},
	{
		...
		Data:               string(test.ReadFile("./testdata/fba/helloMsgFBA.json")),
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "ignoring request, invalid request signature",
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   `"referrer_id":"referral id"`,
		ExpectedURN:        "facebook:5678",
		ExpectedDate:       time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedEvent:      courier.Referral,
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   `ignoring echo`,
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "Not Page",
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "object expected 'page', 'instagram' or 'whatsapp_business_account', found notpage",
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "No Entries",
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "no entries found",
		PrepRequest:        addValidSignature,
	},
	{
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "ignoring request, invalid facebook id",
		PrepRequest:        addValidSignature,
	},
}
...
var testCasesIG = []ChannelHandleTestCase{
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "object expected 'page', 'instagram' or 'whatsapp_business_account', found notinstagram",
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "No Messaging Entries",
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "ignoring request, invalid instagram id",
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "Story Mention",
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   `ignoring story_mention`,
		PrepRequest:        addValidSignature,
	},
	{
...
var testCasesWAC = []ChannelHandleTestCase{
	...
	},
	{
		...
		Data:               "not json",
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "unable to parse",
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "Receive Invalid JSON",
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "ignoring request, invalid whatsapp id",
		PrepRequest:        addValidSignature,
	},
	{
		Label:              "Receive Invalid JSON",
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   "ignoring request, invalid timestamp",
		PrepRequest:        addValidSignature,
	},
	{
	...
	},
	{
		...
		ExpectedRespStatus: 200,
		ExpectedRespBody:   `"ignoring status: deleted"`,
		PrepRequest:        addValidSignature,
	},
	{
