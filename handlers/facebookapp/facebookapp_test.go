...
var testCasesFBA = []ChannelHandleTestCase{
	{
		...
		ExpectedURN:           Sp("facebook:5678"),
		ExpectedExternalID:    Sp("external_id"),
	...
	},
	{
		...
		Data:             string(test.ReadFile("./testdata/fba/helloMsgFBA.json")),
		ExpectedStatus:   400,
		ExpectedResponse: "invalid request signature",
	...
	},
	{
		...
		ExpectedStatus:            200,
		ExpectedResponse:          "Handled",
		ExpectedURN:               Sp("facebook:ref:optin_user_ref"),
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.Referral,
		ExpectedChannelEventExtra: map[string]interface{}{"referrer_id": "optin_ref"},
		PrepRequest:               addValidSignature,
	},
	{
		Label:                     "Receive OptIn",
	...
	},
	{
		...
		ExpectedURN:               Sp("facebook:5678"),
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.NewConversation,
		ExpectedChannelEventExtra: map[string]interface{}{"title": "postback title", "payload": "get_started"},
		PrepRequest:               addValidSignature,
	},
	{
		...
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.Referral,
		ExpectedChannelEventExtra: map[string]interface{}{"title": "postback title", "payload": "postback payload", "referrer_id": "postback ref", "source": "postback source", "type": "postback type"},
		PrepRequest:               addValidSignature,
	},
	{
		...
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.Referral,
		ExpectedChannelEventExtra: map[string]interface{}{"title": "postback title", "payload": "get_started", "referrer_id": "postback ref", "source": "postback source", "type": "postback type", "ad_id": "ad id"},
		PrepRequest:               addValidSignature,
	},
	{
		Label:                     "Receive Referral",
		...
		ExpectedStatus:            200,
		ExpectedResponse:          `"referrer_id":"referral id"`,
		ExpectedURN:               Sp("facebook:5678"),
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.Referral,
		ExpectedChannelEventExtra: map[string]interface{}{"referrer_id": "referral id", "source": "referral source", "type": "referral type", "ad_id": "ad id"},
		PrepRequest:               addValidSignature,
	},
	{
		Label:              "Receive DLR",
	...
	},
	{
		...
		ExpectedStatus:   200,
		ExpectedResponse: `ignoring echo`,
		PrepRequest:      addValidSignature,
	},
	{
		Label:            "Not Page",
		...
		ExpectedStatus:   400,
		ExpectedResponse: "object expected 'page', 'instagram' or 'whatsapp_business_account', found notpage",
		PrepRequest:      addValidSignature,
	},
	{
		Label:            "No Entries",
		...
		ExpectedStatus:   400,
		ExpectedResponse: "no entries found",
		PrepRequest:      addValidSignature,
	},
	{
	...
	},
	{
		...
		ExpectedStatus:   400,
		ExpectedResponse: "invalid facebook id",
		PrepRequest:      addValidSignature,
	},
}
...
var testCasesIG = []ChannelHandleTestCase{
	...
	},
	{
		...
		ExpectedDate:              time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedChannelEvent:      courier.NewConversation,
		ExpectedChannelEventExtra: map[string]interface{}{"title": "icebreaker question", "payload": "get_started"},
		PrepRequest:               addValidSignature,
	},
	{
		Label:            "Different Page",
	...
	},
	{
		...
		ExpectedStatus:   400,
		ExpectedResponse: "object expected 'page', 'instagram' or 'whatsapp_business_account', found notinstagram",
		PrepRequest:      addValidSignature,
	},
	{
		Label:            "No Messaging Entries",
	...
	},
	{
		...
		ExpectedStatus:   400,
		ExpectedResponse: "invalid instagram id",
		PrepRequest:      addValidSignature,
	},
	{
		Label:            "Story Mention",
		...
		ExpectedStatus:   200,
		ExpectedResponse: `ignoring story_mention`,
		PrepRequest:      addValidSignature,
	},
	{
...
var testCasesWAC = []ChannelHandleTestCase{
	...
	},
	{
		...
		Data:             "not json",
		ExpectedStatus:   400,
		ExpectedResponse: "unable to parse",
		PrepRequest:      addValidSignature,
	},
	{
		Label:            "Receive Invalid JSON",
	...
	},
	{
		...
		ExpectedStatus:   400,
		ExpectedResponse: "invalid timestamp",
		PrepRequest:      addValidSignature,
	},
	{
	...
	},
	{
		...
		ExpectedStatus:   400,
		ExpectedResponse: `"unknown status: in_orbit"`,
		PrepRequest:      addValidSignature,
	},
	{
		...
		ExpectedStatus:   200,
		ExpectedResponse: `"ignoring status: deleted"`,
		PrepRequest:      addValidSignature,
	},
	{
...
func TestVerify(t *testing.T) {
	RunChannelTestCases(t, testChannelsFBA, newHandler("FBA", "Facebook", false), []ChannelHandleTestCase{
		...
		},
		{
			...
			URL:              "/c/fba/receive",
			ExpectedStatus:   400,
			ExpectedResponse: "unknown request",
		},
		{
			Label:            "Verify No Secret",
			URL:              "/c/fba/receive?hub.mode=subscribe",
			ExpectedStatus:   400,
			ExpectedResponse: "token does not match secret",
		},
		{
