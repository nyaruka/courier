...
var testCasesFBA = []ChannelHandleTestCase{
	...
	{
		Label:                "Receive Notification Token",
		URL:                  "/c/fba/receive",
		Data:                 string(test.ReadFile("./testdata/fba/notificationMessageToken.json")),
		ExpectedRespStatus:   200,
		ExpectedBodyContains: "Handled",
		ExpectedURN:          "facebook:5678",
		ExpectedDate:         time.Date(2016, 4, 7, 1, 11, 27, 970000000, time.UTC),
		ExpectedEvent:        courier.FacebookNotications,
		ExpectedEventExtra: map[string]interface{}{
			notificationMessageToken:    "NOTIFICATION_TOKEN",
			notificationMessageTimezone: "NOTIFICATION_TIMEZONE",
			notificationMessageStatus:   "RESUME NOTIFICATIONS",
			userTokenStatus:             "REFRESHED",
			tokenExpiryTimestamp:        int64(1509991487970),
