	...
	tsc := []struct {
		...
		},
		{
			...
			&viber.Keyboard{
				...
				[]viber.KeyboardButton{
					...
					{ActionType: "reply", TextSize: "regular", ActionBody: "C", Text: "C", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "D", Text: "D", Columns: "3"},
				},
			},
			map[string]interface{}{},
		},
		{
			...
			&viber.Keyboard{
				...
				false,
				[]viber.KeyboardButton{
					{ActionType: "reply", TextSize: "regular", ActionBody: "Vanilla", Text: "Vanilla", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "Chocolate", Text: "Chocolate", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "Mint", Text: "Mint", Columns: "3"},
					...
					{ActionType: "reply", TextSize: "regular", ActionBody: "Strawberry", Text: "Strawberry", Columns: "3"},
				},
			},
			map[string]interface{}{},
		},
		{
			...
			&viber.Keyboard{
				...
				[]viber.KeyboardButton{
					...
					{ActionType: "reply", TextSize: "regular", ActionBody: "C", Text: "C", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "D", Text: "D", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "Chicken", Text: "Chicken", Columns: "3"},
					{ActionType: "reply", TextSize: "regular", ActionBody: "Fish", Text: "Fish", Columns: "3"},
