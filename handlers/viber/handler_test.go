...
var buttonLayoutSendTestCases = []OutgoingTestCase{
	{
		...
		MsgURN:          "viber:xy5/5y6O81+/kbWHpLhBoA==",
		MsgQuickReplies: []models.QuickReply{{Type: "text", Text: "a"}, {Type: "text", Text: "b"}, {Type: "text", Text: "c"}, {Type: "text", Text: "d"}},
		MockResponses: map[string][]*httpx.MockResponse{
			"https://chatapi.viber.com/pa/send_message": {
				httpx.NewMockResponse(200, nil, []byte(`{"status":0,"status_message":"ok","message_token":4987381194038857789}`)),
			},
...
var testCases = []IncomingTestCase{
	...
	{Label: "Receive invalid signature", URL: receiveURL, Data: validMsg, ExpectedRespStatus: 401, ExpectedBodyContains: "invalid request signature",
		ExpectedLogType: models.ChannelLogTypeReceive, PrepRequest: addInvalidSignature},
	...
	{Label: "Unexpected event", URL: receiveURL, Data: unexpectedEvent, ExpectedRespStatus: 400,
		ExpectedBodyContains: "not handled, unknown event: unexpected", ExpectedLogType: models.ChannelLogTypeReceive,
		PrepRequest: addValidSignature},
...
var testWelcomeMessageCases = []IncomingTestCase{
		...
		PrepRequest:          addValidSignature},
	{
		...
		ExpectedRespStatus:   200,
		ExpectedBodyContains: `{"auth_token":"Token","text":"Welcome to VP, Please subscribe here for more.","type":"text","tracking_data":"0199dd4c-9e10-7000-9955-f9b28b006b78"}`,
		ExpectedEvents: []ExpectedEvent{
