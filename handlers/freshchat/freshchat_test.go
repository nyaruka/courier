...
var sigtestCases = []ChannelHandleTestCase{
	...
	},
	{
		...
		ExpectedRespBody:   `{"message":"Error","data":[{"type":"error","error":"unable to verify signature, crypto/rsa: verification error"}]}`,
	},
}
...
var testCases = []ChannelHandleTestCase{
	...
	},
	{
		...
		Data:               "empty",
		ExpectedRespStatus: 400,
		ExpectedRespBody:   `{"message":"Error","data":[{"type":"error","error":"unable to parse request JSON: invalid character 'e' looking for beginning of value"}]}`,
	},
}
