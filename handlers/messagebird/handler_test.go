...
const (
	...
	statusBaseURL         = "/c/mbd/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?datacoding=plain&id=b6aae1b5dfb2427a8f7ea6a717ba31a9&mccmnc=310010&messageLength=4&messagePartCount=1&ported=0&price%5Bamount%5D=0.000&price%5Bcurrency%5D=USD&recipient=18885551515&reference=019a0719-ac96-7eb9-a837-cac215164834&statusDatetime=2023-07-28T17%3A57%3A12%2B00%3A00"
...
var defaultReceiveTestCases = []IncomingTestCase{
	...
	},
	{
		...
		ExpectedBodyContains: `{"message":"Unauthorized","data":[{"type":"error","error":"token signature is invalid: signature is invalid"}]}`,
	...
	},
	{
		...
		Data:                 validReceive,
		ExpectedRespStatus:   401,
		ExpectedBodyContains: `{"message":"Unauthorized","data":[{"type":"error","error":"missing request signature"}]}`,
	},
	{
		...
		Data:                 validReceive,
		ExpectedRespStatus:   401,
		ExpectedBodyContains: `{"message":"Unauthorized","data":[{"type":"error","error":"invalid request signature, signature doesn't match expected signature for body."}]}`,
