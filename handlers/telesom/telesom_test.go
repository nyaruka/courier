...
var defaultSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		...
		PostParams: map[string]string{"msg": "Simple Message", "to": "0788383383", "from": "2020", "key": "D69BB824F88F20482B94ECF3822EBD84"},
	...
	{Label: "Unicode Send",
		...
		Status:       "W",
		ResponseBody: "<return>Success</return>", ResponseStatus: 200,
		PostParams: map[string]string{"msg": "☺", "to": "0788383383", "from": "2020", "key": "60421A7D99BD79FE02697D567315AD0E"},
		Headers:    map[string]string{"Content-Type": "application/x-www-form-urlencoded"},
		SendPrep:   setSendURL},
	{Label: "Error Sending",
		...
		PostParams: map[string]string{"msg": `Error Message`, "to": "0788383383", "from": "2020", "key": "3F1E492B2186551570F24C2F07D5D7E2"},
		Headers:    map[string]string{"Content-Type": "application/x-www-form-urlencoded"},
		SendPrep:   setSendURL},
