...
var defaultSendTestCases = []OutgoingTestCase{
...

	{
		...
		MockResponseBody:   `{ "ok": true, "result": { "message_id": 133 } }`,
		MockResponseStatus: 200,
		ExpectedPostParams: map[string]string{"text": "☺", "chat_id": "12345", "parse_mode": "MarkdownV2"},
		ExpectedMsgStatus:  "W",
		ExpectedExternalID: "133",
		SendPrep:           setSendURL,
	},
	{
		...
		ExpectedPostParams: map[string]string{"text": `Error`, "chat_id": "12345", "parse_mode": "MarkdownV2"},
	...
	},
	{
		...
		MockResponseStatus: 403,
		ExpectedPostParams: map[string]string{"text": `Stopped Contact`, "chat_id": "12345", "parse_mode": "MarkdownV2"},
		ExpectedMsgStatus:  "F",
	...
	},
	{
		...
		MockResponseBody:   `{ "ok": true, "result": { "message_id": 133 } }`,
		MockResponseStatus: 200,
		ExpectedPostParams: map[string]string{"caption": "My pic!", "chat_id": "12345", "parse_mode": "MarkdownV2", "photo": "https://foo.bar/image.jpg"},
		ExpectedMsgStatus:  "W",
		SendPrep:           setSendURL,
	},
	{
		...
		MockResponseBody:   `{ "ok": true, "result": { "message_id": 133 } }`,
		MockResponseStatus: 200,
		ExpectedPostParams: map[string]string{"caption": "My vid!", "chat_id": "12345", "parse_mode": "MarkdownV2", "video": "https://foo.bar/video.mpeg"},
		ExpectedMsgStatus:  "W",
		SendPrep:           setSendURL,
	},
	{
		...
		MockResponseBody:   `{ "ok": true, "result": { "message_id": 133 } }`,
		MockResponseStatus: 200,
		ExpectedPostParams: map[string]string{"caption": "My audio!", "chat_id": "12345", "parse_mode": "MarkdownV2", "audio": "https://foo.bar/audio.mp3"},
		ExpectedMsgStatus:  "W",
		SendPrep:           setSendURL,
	},
	{
		...
		MockResponseBody:   `{ "ok": true, "result": { "message_id": 133 } }`,
		MockResponseStatus: 200,
		ExpectedPostParams: map[string]string{"caption": "My document!", "chat_id": "12345", "parse_mode": "MarkdownV2", "document": "https://foo.bar/document.pdf"},
		ExpectedMsgStatus:  "W",
		SendPrep:           setSendURL,
	},
	{
