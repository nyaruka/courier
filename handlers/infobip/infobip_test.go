...
var defaultSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		...
		ExpectedStatus: "W", ExpectedExternalID: "12345",
		MockResponseBody: `{"messages":[{"status":{"groupId": 1}, "messageId": "12345"}}`, MockResponseStatus: 200,
	...
	{Label: "Unicode Send",
		...
		ExpectedStatus:   "W",
		MockResponseBody: `{"messages":[{"status":{"groupId": 1}}}`, MockResponseStatus: 200,
		ExpectedHeaders: map[string]string{
			"Content-Type":  "application/json",
			"Accept":        "application/json",
			"Authorization": "Basic VXNlcm5hbWU6UGFzc3dvcmQ=",
	...
	{Label: "Error groupId",
		MsgText: "Simple Message", MsgURN: "tel:+250788383383",
		ExpectedStatus:   "E",
		MockResponseBody: `{"messages":[{"status":{"groupId": 2}}}`, MockResponseStatus: 200,
		ExpectedHeaders: map[string]string{
			"Content-Type":  "application/json",
			"Accept":        "application/json",
			"Authorization": "Basic VXNlcm5hbWU6UGFzc3dvcmQ=",
