...
var notificationSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		MsgText: "Simple Message", MsgURN: "fcm:250788123123", MsgURNAuth: "auth1",
		ExpectedStatus: "W", ExpectedExternalID: "123456",
		MockResponseBody: `{"success":1, "multicast_id": 123456}`, MockResponseStatus: 200,
...
var sendTestCases = []ChannelSendTestCase{
	...
	{Label: "Long Message",
		MsgText: longMsg,
		MsgURN:  "fcm:250788123123", MsgURNAuth: "auth1",
		ExpectedStatus: "W", ExpectedExternalID: "123456",
		MockResponseBody: `{"success":1, "multicast_id": 123456}`, MockResponseStatus: 200,
		ExpectedHeaders:     map[string]string{"Authorization": "key=FCMKey"},
		...
		SendPrep:            setSendURL},
	{Label: "Quick Reply",
		MsgText: "Simple Message", MsgURN: "fcm:250788123123", MsgURNAuth: "auth1", MsgQuickReplies: []string{"yes", "no"}, MsgAttachments: []string{"image/jpeg:https://foo.bar"},
		ExpectedStatus: "W", ExpectedExternalID: "123456",
		MockResponseBody: `{"success":1, "multicast_id": 123456}`, MockResponseStatus: 200,
		ExpectedHeaders:     map[string]string{"Authorization": "key=FCMKey"},
		...
		SendPrep:            setSendURL},
	{Label: "Error",
		MsgText: "Error", MsgURN: "fcm:250788123123", MsgURNAuth: "auth1",
		ExpectedStatus:   "E",
		MockResponseBody: `{ "success": 0 }`, MockResponseStatus: 200,
		SendPrep: setSendURL},
	{Label: "No Multicast ID",
		MsgText: "Error", MsgURN: "fcm:250788123123", MsgURNAuth: "auth1",
		ExpectedStatus:   "E",
		MockResponseBody: `{ "success": 1 }`, MockResponseStatus: 200,
		SendPrep: setSendURL},
	{Label: "Request Error",
		MsgText: "Error", MsgURN: "fcm:250788123123", MsgURNAuth: "auth1",
		ExpectedStatus:   "E",
		MockResponseBody: `{ "success": 0 }`, MockResponseStatus: 500,
		SendPrep: setSendURL},
}
