...
var defaultSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		...
		ExpectedStatus: "W", ExpectedExternalID: "id1002",
		ExpectedURLParams: map[string]string{"content": "Simple Message", "to": "250788383383", "from": "2020", "apiKey": "API-KEY"},
		MockResponseBody:  successSendResponse, MockResponseStatus: 200,
		SendPrep: setSendURL},
	{Label: "Unicode Send",
	...
	{Label: "Error Response",
		...
		ExpectedStatus:    "E",
		ExpectedURLParams: map[string]string{"content": "Error Message", "to": "250788383383", "from": "2020", "apiKey": "API-KEY"},
		MockResponseBody:  failSendResponse, MockResponseStatus: 200,
		SendPrep: setSendURL},
}
