...
var handleTestCases = []ChannelHandleTestCase{
	{Label: "Receive Valid Message", URL: receiveURL, Data: receiveValidMessage, ExpectedRespStatus: 200, ExpectedRespBody: "ACK/Jasmin",
		ExpectedMsgText: Sp("événement"), ExpectedURN: "tel:+2349067554729", ExpectedExternalID: "1001"},
	{Label: "Receive Missing To", URL: receiveURL, Data: receiveMissingTo, ExpectedRespStatus: 400,
		ExpectedRespBody: "field 'to' required"},
	{Label: "Invalid URN", URL: receiveURL, Data: invalidURN, ExpectedRespStatus: 400,
		ExpectedRespBody: "phone number supplied is not a number"},
	{Label: "Status Delivered", URL: statusURL, Data: statusDelivered, ExpectedRespStatus: 200, ExpectedRespBody: "ACK/Jasmin",
		ExpectedMsgStatus: "D", ExpectedExternalID: "external1"},
	{Label: "Status Failed", URL: statusURL, Data: statusFailed, ExpectedRespStatus: 200, ExpectedRespBody: "ACK/Jasmin",
		ExpectedMsgStatus: "F", ExpectedExternalID: "external1"},
	{Label: "Status Missing", URL: statusURL, ExpectedRespStatus: 400, Data: "nothing",
		ExpectedRespBody: "field 'id' required"},
	{Label: "Status Unknown", URL: statusURL, ExpectedRespStatus: 400, Data: statusUnknown,
		ExpectedRespBody: "must have either dlvrd or err set to 1"},
}
