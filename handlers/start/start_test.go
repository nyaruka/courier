...
var testCases = []ChannelHandleTestCase{
	{Label: "Receive Valid", URL: receiveURL, Data: validReceive, ExpectedRespStatus: 200, ExpectedRespBody: "<state>Accepted</state>",
		ExpectedMsgText: Sp("Hello World"), ExpectedURN: "tel:+250788123123", ExpectedDate: time.Date(2015, 12, 18, 15, 02, 54, 0, time.UTC)},
	{Label: "Receive Valid Encoded", URL: receiveURL, Data: validReceiveEncoded, ExpectedRespStatus: 200, ExpectedRespBody: "<state>Accepted</state>",
		ExpectedMsgText: Sp("Кохання"), ExpectedURN: "tel:+380501529999", ExpectedDate: time.Date(2015, 12, 18, 15, 02, 54, 0, time.UTC)},
	{Label: "Receive Valid with empty Text", URL: receiveURL, Data: validReceiveEmptyText, ExpectedRespStatus: 200, ExpectedRespBody: "<state>Accepted</state>",
		ExpectedMsgText: Sp(""), ExpectedURN: "tel:+250788123123"},
	{Label: "Receive Valid missing body", URL: receiveURL, Data: validMissingBody, ExpectedRespStatus: 200, ExpectedRespBody: "<state>Accepted</state>",
		ExpectedMsgText: Sp(""), ExpectedURN: "tel:+250788123123"},
	{Label: "Receive invalidURN", URL: receiveURL, Data: invalidURNReceive, ExpectedRespStatus: 400, ExpectedRespBody: "phone number supplied is not a number"},
	{Label: "Receive missing Request ID", URL: receiveURL, Data: missingRequestID, ExpectedRespStatus: 400, ExpectedRespBody: "Error"},
	{Label: "Receive missing From", URL: receiveURL, Data: missingFrom, ExpectedRespStatus: 400, ExpectedRespBody: "Error"},
	{Label: "Receive missing To", URL: receiveURL, Data: missingTo, ExpectedRespStatus: 400, ExpectedRespBody: "Error"},
	{Label: "Invalid XML", URL: receiveURL, Data: notXML, ExpectedRespStatus: 400, ExpectedRespBody: "Error"},
}
