...
var jsonSendTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		...
		SendPrep:            setSendURL},
	{Label: "Unicode Send",
		MsgText: `☺ "hi!"`, MsgURN: "tel:+250788383383",
		ExpectedStatus:   "W",
		MockResponseBody: "0: Accepted for delivery", MockResponseStatus: 200,
	...
	{Label: "Send Quick Replies",
		MsgText: "Some message", MsgURN: "tel:+250788383383", MsgQuickReplies: []string{"One", "Two", "Three"},
		ExpectedStatus:   "W",
		MockResponseBody: "0: Accepted for delivery", MockResponseStatus: 200,
...
var xmlSendTestCases = []ChannelSendTestCase{
	...
	{Label: "Send Quick Replies",
		...
		ExpectedStatus:   "W",
		MockResponseBody: "0: Accepted for delivery", MockResponseStatus: 200,
		ExpectedRequestBody: "<msg><to>+250788383383</to><text>Some message</text><from>2020</from>" +
...
var xmlLongSendTestCases = []ChannelSendTestCase{
	{Label: "Send Quick Replies",
		...
		ExpectedStatus:   "W",
		MockResponseBody: "0: Accepted for delivery", MockResponseStatus: 200,
		ExpectedRequestBody: "<msg><to>+250788383383</to><text>characters</text><from>2020</from>" +
			"<quick_replies><item>One</item><item>Two</item><item>Three</item></quick_replies></msg>",
		ExpectedHeaders: map[string]string{"Content-Type": "text/xml; charset=utf-8"},
		SendPrep:        setSendURL},
}
...
var xmlSendWithResponseContentTestCases = []ChannelSendTestCase{
	{Label: "Plain Send",
		MsgText: "Simple Message", MsgURN: "tel:+250788383383",
		ExpectedStatus:   "W",
		MockResponseBody: "<return>0</return>", MockResponseStatus: 200,
		ExpectedRequestBody: `<msg><to>+250788383383</to><text>Simple Message</text><from>2020</from><quick_replies></quick_replies></msg>`,
		ExpectedHeaders:     map[string]string{"Content-Type": "text/xml; charset=utf-8"},
		SendPrep:            setSendURL},
	{Label: "Unicode Send",
	...
	{Label: "Error Sending",
		MsgText: "Error Message", MsgURN: "tel:+250788383383",
		ExpectedStatus:   "E",
		MockResponseBody: "<return>0</return>", MockResponseStatus: 401,
		ExpectedRequestBody: `<msg><to>+250788383383</to><text>Error Message</text><from>2020</from><quick_replies></quick_replies></msg>`,
		ExpectedHeaders:     map[string]string{"Content-Type": "text/xml; charset=utf-8"},
		SendPrep:            setSendURL},
	{Label: "Error Sending with 200 status code",
		MsgText: "Error Message", MsgURN: "tel:+250788383383",
		ExpectedStatus:   "E",
		MockResponseBody: "<return>1</return>", MockResponseStatus: 200,
		ExpectedRequestBody: `<msg><to>+250788383383</to><text>Error Message</text><from>2020</from><quick_replies></quick_replies></msg>`,
		ExpectedHeaders:     map[string]string{"Content-Type": "text/xml; charset=utf-8"},
		SendPrep:            setSendURL},
	{Label: "Send Attachment",
