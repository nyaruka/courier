...
var defaultSendTestCases = []OutgoingTestCase{
		...
		ExpectedRequests: []ExpectedRequest{
			{
				...
				Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"This is a longer message than 160 characters and will cause us to split it into two separate parts, isn't that right but it is even longer than before I say,"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"I need to keep adding more things to make it work"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
	...
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Message"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
	...
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Code"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
	...
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Stopped Contact"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
	...
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"No SID"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Form: url.Values{
					...
					"From":           []string{"2020"},
					"StatusCallback": []string{"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"},
				},
			},
		},
		ExpectedExtIDs: []string{"1002"},
...
var tmsDefaultSendTestCases = []OutgoingTestCase{
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002"},
	},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"This is a longer message than 160 characters and will cause us to split it into two separate parts, isn't that right but it is even longer than before I say,"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"I need to keep adding more things to make it work"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002", "1002"},
	},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"Error Message"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedError: courier.ErrResponseStatus,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Code"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrFailedWithReason("1001", "Service specific error: 1001."),
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Stopped Contact"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrContactStopped,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"No SID"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedLogErrors: []*clogs.Error{courier.ErrorResponseValueMissing("sid")},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"My pic!"}, "To": {"+250788383383"}, "MediaUrl": {"https://foo.bar/image.jpg"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
}
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"+250788383383"}, "MessagingServiceSid": {"messageServiceSID"}, "ShortenUrls": {"true"}, "StatusCallback": {"https://localhost/c/tms/8eb23e93-5ecb-45ba-b726-3b064e0c56cd/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002"},
	},
...
var twDefaultSendTestCases = []OutgoingTestCase{
		...
		ExpectedRequests: []ExpectedRequest{
			{
				...
				Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002"},
	},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/twiml_api/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"This is a longer message than 160 characters and will cause us to split it into two separate parts, isn't that right but it is even longer than before I say,"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/twiml_api/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"I need to keep adding more things to make it work"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002", "1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Message"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrResponseStatus,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Code"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrFailedWithReason("1001", "Service specific error: 1001."),
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Stopped Contact"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrContactStopped,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"No SID"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedLogErrors: []*clogs.Error{courier.ErrorResponseValueMissing("sid")},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"My pic!"}, "To": {"+250788383383"}, "MediaUrl": {"https://foo.bar/image.jpg"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/tw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
}
...
var swSendTestCases = []OutgoingTestCase{
		...
		ExpectedRequests: []ExpectedRequest{
			{
				...
				Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002"},
	},
		...
		ExpectedRequests: []ExpectedRequest{
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/sigware_api/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"This is a longer message than 160 characters and will cause us to split it into two separate parts, isn't that right but it is even longer than before I say,"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
			{
				Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
				Path:    "/sigware_api/2010-04-01/Accounts/accountSID/Messages.json",
				Form:    url.Values{"Body": {"I need to keep adding more things to make it work"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			},
		},
		ExpectedExtIDs: []string{"1002", "1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Message"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrResponseStatus,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Error Code"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrFailedWithReason("1001", "Service specific error: 1001."),
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"Stopped Contact"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedError: courier.ErrContactStopped,
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"No SID"}, "To": {"+250788383383"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedLogErrors: []*clogs.Error{courier.ErrorResponseValueMissing("sid")},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form: url.Values{"Body": {"My pic!"}, "To": {"+250788383383"}, "MediaUrl": {"https://foo.bar/image.jpg"}, "From": {"2020"}, "StatusCallback": {"https://localhost/c/sw/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
}
...
var waSendTestCases = []OutgoingTestCase{
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "StatusCallback": {"https://localhost/c/t/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}, "ContentSid": {"ext_id_revive_issue"}, "ContentVariables": {"{\"1\":\"Chef\",\"2\":\"tomorrow\"}"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
...
var twaSendTestCases = []OutgoingTestCase{
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"Body": {"Simple Message ☺"}, "To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/twa/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/twa/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}, "ContentSid": {"ext_id_revive_issue"}, "ContentVariables": {"{\"1\":\"Chef\",\"2\":\"tomorrow\"}"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/twa/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}, "ContentSid": {"ext_id_revive_issue"}, "ContentVariables": {"{\"1\":\"Chef: common resto\",\"2\":\"tomorrow\"}"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
	{
		...
		ExpectedRequests: []ExpectedRequest{{
			Form:    url.Values{"To": {"whatsapp:+250788383383"}, "From": {"whatsapp:+12065551212"}, "MessagingServiceSid": {"messageServiceSID"}, "StatusCallback": {"https://localhost/c/twa/8eb23e93-5ecb-45ba-b726-3b064e0c56ab/status?id=0f39d3b2-a84f-4274-ab54-32fbdf0a2d3c&action=callback"}, "ContentSid": {"ext_id_revive_issue"}, "ContentVariables": {"{\"1\":\"http://example.com/cat2.jpg\",\"2\":\"tomorrow\"}"}},
			Headers: map[string]string{"Authorization": "Basic YWNjb3VudFNJRDphdXRoVG9rZW4="},
		}},
		ExpectedExtIDs: []string{"1002"},
	},
