...
var twaTestCases = []IncomingTestCase{
	...
	{Label: "Receive BSUID Valid", URL: twaReceiveURL, Data: waReceiveBSUIDValid, ExpectedRespStatus: 200, ExpectedBodyContains: "<Response/>",
		ExpectedMsgText: Sp("Msg"), ExpectedURN: "tel:+14133881111", ExpectedNewURN: &models.NewURNSpec{Value: "whatsapp:US.1234", Action: models.NewURNAppend}, ExpectedExternalID: "SMe287d7109a5a925f182f0e07fe5b223b",
		PrepRequest: addValidSignature},
