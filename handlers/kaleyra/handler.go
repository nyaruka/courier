...
func (h *handler) Initialize(r *channels.Routes) error {
	r.AddReceive(h, http.MethodGet, "receive", channels.KindMsg, handlers.FormPayload(h.receiveMsg))
	r.AddReceive(h, http.MethodGet, "status", channels.KindStatus, handlers.FormPayload(h.receiveStatus))
	return nil
}
