...
var waTestCases = []ChannelHandleTestCase{
	{Label: "Receive Valid Message", URL: waReceiveURL, Data: helloMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedContactName: Sp("Jerry Cooney"), ExpectedMsgText: Sp("hello world"), ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	{Label: "Receive Duplicate Valid Message", URL: waReceiveURL, Data: duplicateMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp("hello world"), ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	{Label: "Receive Valid Audio Message", URL: waReceiveURL, Data: audioMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp(""), ExpectedAttachments: []string{"https://foo.bar/v1/media/41"}, ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	{Label: "Receive Valid Button Message", URL: waReceiveURL, Data: buttonMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp("BUTTON1"), ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	{Label: "Receive Valid Document Message", URL: waReceiveURL, Data: documentMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp("the caption"), ExpectedAttachments: []string{"https://foo.bar/v1/media/41"}, ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	...
	{Label: "Receive Valid Interactive List Message", URL: waReceiveURL, Data: interactiveListMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp("ROW1"), ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
	{Label: "Receive Valid Location Message", URL: waReceiveURL, Data: locationMsg, ExpectedStatus: 200, ExpectedResponse: `"type":"msg"`,
		ExpectedMsgText: Sp(""), ExpectedAttachments: []string{"geo:0.000000,1.000000"}, ExpectedURN: Sp("whatsapp:250788123123"), ExpectedExternalID: Sp("41"), ExpectedDate: time.Date(2016, 1, 30, 1, 57, 9, 0, time.UTC)},
