...
var defaultSendTestCases = []ChannelSendTestCase{
	...
	{Label: "WhatsApp Tiers Hit",
		Text: "WA tier reached, try next day", URN: "whatsapp:250788123123",
		Status:              "E",
		NextAttemptInterval: "24 hours",
		RequestBody:         `{"to":"250788123123","type":"text","text":{"body":"WA tier reached, try next day"}}`, ResponseStatus: 400,
		ResponseBody: `{"errors": [{"code":471,"title":"Spam rate limit hit","details":"Please try again after 24 hours"}]}`,
		SendPrep:     setSendURL,
	},
