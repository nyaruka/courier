...
func TestHandling(t *testing.T) {
	...
	msg := test.NewMockMsg(courier.NewMsgID(101), courier.NilMsgUUID, brokenChannel, "tel:+250788383383", "test message")
	...
	msg = test.NewMockMsg(courier.NewMsgID(102), courier.NilMsgUUID, mockChannel, "tel:+250788383383", "test message 2")
