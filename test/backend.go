...
func (mb *MockBackend) NewOutgoingMsg(channel courier.Channel, id models.MsgID, uuid models.MsgUUID, urn urns.URN, text string, highPriority bool, quickReplies []models.QuickReply,
