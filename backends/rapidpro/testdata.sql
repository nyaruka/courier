...
INSERT INTO orgs_org
       ("id", "name", "language", "is_anon", "config")
VALUES(1, 'Test Org', 'eng', FALSE, '{ "CHATBASE_API_KEY": "cak" }');

/* Channel with id 10, 11, 12 */
DELETE FROM channels_channel;
INSERT INTO channels_channel
       ("id", "schemes", "is_active", "created_on", "modified_on", "uuid", "channel_type", "address", "org_id", "country", "role", "config")
...
INSERT INTO channels_channel
       ("id", "schemes", "is_active", "created_on", "modified_on", "uuid", "channel_type", "address", "org_id", "country", "role", "config")
VALUES('17', '{"tel"}', 'N', NOW(), NOW(), '904e6553-6dab-41be-9a99-fd4fdf7cc52b', 'EX', '1000', 1, 'US', 'SR', NULL);

/* Contacts with ids 100, 101 */
DELETE FROM contacts_contact;
INSERT INTO contacts_contact
       ("id", "is_active", "status", "created_on", "modified_on", "uuid", "language", "ticket_count", "created_by_id", "modified_by_id", "org_id")
...
INSERT INTO contacts_contacturn
       ("id", "identity", "path", "scheme", "priority", "channel_id", "contact_id", "org_id")
VALUES(1000, 'tel:+12067799192', '+12067799192', 'tel', 50, 10, 100, 1);

/** Msg with id 10,000 */
DELETE from msgs_msg;
INSERT INTO msgs_msg
       ("id", "text", "high_priority", "created_on", "modified_on", "sent_on", "queued_on", "direction", "status", "visibility",
...
INSERT INTO msgs_msg
       ("id", "text", "high_priority", "created_on", "modified_on", "sent_on", "queued_on", "direction", "status", "visibility",
       "msg_count", "error_count", "next_attempt", "external_id", "channel_id", "contact_id", "contact_urn_id", "org_id")
VALUES(10003, 'test message', True, now(), now(), now(), now(), 'O', 'P', 'V',
              1, 0, now(), 'ext1', 17, 100, 1000, 1);

INSERT INTO msgs_media
       ("id", "uuid", "org_id", "content_type", "url", "path", "size", "duration", "width", "height", "original_id")
